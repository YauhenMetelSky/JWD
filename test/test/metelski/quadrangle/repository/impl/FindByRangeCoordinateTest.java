...
public class FindByRangeCoordinateTest extends Assert {
    ...
    public void testSpecify(int minX, int maxX, int minY, int maxY, Quadrangle quadrangle, boolean expectedResult) {
    ...
    public Object[][] findByRangeCoordinateData() {
        return new Object[][]{
                {-3, 3, -4, 4, quadrangle, false},
                {-5, 0, -4, 4, quadrangle, false},
                {-5, 3, -1, 4, quadrangle, false},
                {-5, 3, -4, 2, quadrangle, false},
                {-5, 3, -4, 4, quadrangle, true}
        };
    }
}
