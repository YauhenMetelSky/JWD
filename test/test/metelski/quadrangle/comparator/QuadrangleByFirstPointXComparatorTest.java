...
public class QuadrangleByFirstPointXComparatorTest extends Assert {
    ...
    public void testCompare(Quadrangle quadrangle1, Quadrangle quadrangle2, int expectedResult) {
        int actualResult = new QuadrangleByFirstPointXComparator().compare(quadrangle1, quadrangle2);
    ...
    public Object[][] testCompareData() {
        return new Object[][]{
                {quadrangle1, quadrangle2, -4},
                {quadrangle1, quadrangle3, -5},
                {quadrangle1, quadrangle4, -4},
